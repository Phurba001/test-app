...
@csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" value="{{$product->name}}" class="mt-1 p-2 border rounded w-full focus:outline-none focus:ring focus:border-blue-300">
                </div>
                <div class="mb-4">
                    <label for="email" class="block text-sm font-medium text-gray-700">price</label>
                    <input type="text" id="email" name="price" value="{{$product->price}}" class="mt-1 p-2 border rounded w-full focus:outline-none focus:ring focus:border-blue-300">
                </div>
                <div class="mb-4">
                    <label for="message" class="block text-sm font-medium text-gray-700">description</label>
                    <textarea id="message" name="description" rows="4" value="{{$product->description}}" class="mt-1 p-2 border rounded w-full focus:outline-none focus:ring focus:border-blue-300"></textarea>
                </div>
                <div class="mb-4">
